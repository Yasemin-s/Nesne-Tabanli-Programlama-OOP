...
Foto1 - Burada class, interface, abstractan referans oluşturabilirsin ama o referansın heapte işaret ettiği nesne sadece classtan oluşmalıdır. İnterface classtan vs değil. 
